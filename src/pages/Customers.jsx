                ...
                <div className='row'>
                    ...
                    <main className='col-md-9 col-lg-10 p-4'>
                        <div className='d-flex justify-content-between align-items-center px-3'>
                            ...
                            <p>
                                <Link to='/Dashboard' className='text-decoration-none'>Home</Link> / <span className='text-secondary'>Customers</span>
                            </p>
                        </div>
                                    ...
                                    <tbody>
                                        {
                                            customers.map(customer => (
                                                <tr key={customer.id}>
                                                    ...
                                                    <td className='text-center'><span className='badge text-bg-success'>{customer.status}</span></td>
