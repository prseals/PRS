...
function DieEdit() {
    ...
    const dieToEdit = dies.find(die => die.id === Number(id));

    const [die, setDie] = useState(dieToEdit);
    ...
    function handleEditDie(e) {

        e.preventDefault();

        console.log("Die Update:", die);
            ...
            <div className="container-fluid">
                ...
                <div className="row">
                    ...
                    <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                        ...
                        <PageHeader
                            heading={"Update Die"}
                            para={"This update the die's details"}
                            url={"/Dies"}
                        />


                        <form onSubmit={handleEditDie}>
