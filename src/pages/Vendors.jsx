                ...
                <div className='row'>
                    ...
                    <main className='col-md-9 col-lg-10 p-4'>
                        <div className='d-flex justify-content-between align-items-center px-3'>
                            <h2 className='display-6 mb-3'>Vendors</h2>

                            <p>
                                <Link to='/Dashboard' className='text-decoration-none'>Home</Link> / <span className='text-secondary'>Vendors</span>
                            </p>
                        </div>
                        ...
                        <div className='card p-3 shadow-sm bg-light'>
                            <div className='card-body'>
                                ...
                                <table className='table table-responsive table-bordered table-striped table-hover'>
                                    ...
                                    <tbody>
                                        {/* id, vendorCode, companyName, contactPerson, gstNumber, city, status */}
                                        {
                                            vendors.map(vendor => (
                                                <tr key={vendor.id}>
                                                    ...
                                                    <td className='text-center'><span className='badge text-bg-success'>{vendor.status}</span></td>
