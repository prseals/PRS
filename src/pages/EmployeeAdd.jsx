...
function EmployeeAdd() {
    ...
    function handleSubmit(e) {
        ...
        const newEmployee = {
            ...
            salary: {
                ...employee.salary,
                basicSalary: Number(employee.salary.basicSalary),
                allowances: Number(employee.salary.allowances),
                deductions: Number(employee.salary.deductions),
                netSalary: Number(employee.salary.netSalary)
            }
        };
                ...
                <div className="row">
                    ...
                    <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                        ...
                        <PageHeader
                            ...
                            para={"Add a new employee to your organization"}
                            url={"/Employees"}
                        />
