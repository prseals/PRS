                ...
                <div className='row'>
                    ...
                    <main className='col-md-9 col-lg-10 p-4'>
                        <div className='d-flex justify-content-between align-items-center px-3'>
                            <h2 className='display-6 mb-3'>Machines</h2>

                            <p>
                                <Link to='/Dashboard' className='text-decoration-none'>Home</Link> / <span className='text-secondary'>Machines</span>
                            </p>
                        </div>
                        ...
                        <div className='card p-3 shadow-sm bg-light'>
                            <div className='card-body'>
                                ...
                                <table className='table table-responsive table-bordered table-striped table-hover'>
                                    <thead>
                                        {/* id, machineCode, machineName, machineType, manufacturer, location.plant, status, condition */}
                                        <tr>
                                                    ...
                                                    <td className='text-center'>
                                                        {
                                                            machine.status === "Running" && (
                                                                <span className='badge text-bg-success'>{machine.status}</span>
                                                            )
                                                        }

                                                        {
                                                            machine.status === "Maintenance" && (
                                                                <span className='badge text-bg-danger'>{machine.status}</span>
                                                            )
                                                        }
                                                    </td>
                                                    <td className='text-center'>
                                                        {
                                                            machine.condition === "Needs Maintenance" && (
                                                                <span className='badge text-bg-danger'>{machine.condition}</span>
                                                            )
                                                        }

                                                        {
                                                            machine.condition === "Good" && (
                                                                <span className='badge text-bg-warning'>{machine.condition}</span>
                                                            )
                                                        }

                                                        {
                                                            machine.condition === "Excellent" && (
                                                                <span className='badge text-bg-success'>{machine.condition}</span>
                                                            )
                                                        }
